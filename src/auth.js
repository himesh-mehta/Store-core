/**
 * Authentication Configuration for CampusOne (StoreCore Essentials).
 * Configures credentials providers (Sign In & Sign Up) with Argon2 cryptographic hashing
 * and maps sessions, users, and tokens using a custom Neon PostgreSQL database client pool.
 */
